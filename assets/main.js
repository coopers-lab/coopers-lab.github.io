...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-up', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-up', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('h1.style7, h2.style7, h3.style7, p.style7', { style: 'blur-in', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('.buttons.style1', { style: 'blur-in', speed: 1000, intensity: 1, delay: 0, stagger: 250, staggerSelector: ':scope > li', replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-up', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('.container.style1', { style: 'zoom-in', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('h1.style6, h2.style6, h3.style6, p.style6', { style: 'fade-up', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('.container.style4', { style: 'zoom-in', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('h1.style14, h2.style14, h3.style14, p.style14', { style: 'fade-up', speed: 1000, intensity: 1, delay: 0, replay: false });
